...
public class BookAuthorBidirectionalStreamingClient {
	private final BookAuthorServiceStub stub;
	private StreamObserver<Book> streamClientSender = null;

	public BookAuthorBidirectionalStreamingClient(Channel channel) {
	...
	public void addBook(Book book) {
		...
		if (streamClientSender == null) {
			streamClientSender = stub.getBooksByGender(getServerResponseObserver());
		}
		try {
