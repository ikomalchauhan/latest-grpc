...
public final class BookAuthorServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.optum.grpcserver.BookAuthorService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.optum.grpcserver.Author,
      com.optum.grpcserver.Author> METHOD_GET_AUTHOR =
      io.grpc.MethodDescriptor.<com.optum.grpcserver.Author, com.optum.grpcserver.Author>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.optum.grpcserver.BookAuthorService", "getAuthor"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.optum.grpcserver.Author.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.optum.grpcserver.Author.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.optum.grpcserver.Author,
      com.optum.grpcserver.Book> METHOD_GET_BOOKS_BY_AUTHOR =
      io.grpc.MethodDescriptor.<com.optum.grpcserver.Author, com.optum.grpcserver.Book>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "com.optum.grpcserver.BookAuthorService", "getBooksByAuthor"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.optum.grpcserver.Author.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.optum.grpcserver.Book.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.optum.grpcserver.Book,
      com.optum.grpcserver.Cart> METHOD_GET_EXPENSIVE_BOOK =
      io.grpc.MethodDescriptor.<com.optum.grpcserver.Book, com.optum.grpcserver.Cart>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "com.optum.grpcserver.BookAuthorService", "getExpensiveBook"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.optum.grpcserver.Book.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.optum.grpcserver.Cart.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.optum.grpcserver.Book,
      com.optum.grpcserver.Cart> METHOD_GET_BOOKS_BY_GENDER =
      io.grpc.MethodDescriptor.<com.optum.grpcserver.Book, com.optum.grpcserver.Cart>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "com.optum.grpcserver.BookAuthorService", "getBooksByGender"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.optum.grpcserver.Book.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.optum.grpcserver.Cart.getDefaultInstance()))
  ...
  public static abstract class BookAuthorServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAuthor(com.optum.grpcserver.Author request,
        io.grpc.stub.StreamObserver<com.optum.grpcserver.Author> responseObserver) {
     ...
     * </pre>
     */
    public void getBooksByAuthor(com.optum.grpcserver.Author request,
        io.grpc.stub.StreamObserver<com.optum.grpcserver.Book> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.optum.grpcserver.Book> getExpensiveBook(
        io.grpc.stub.StreamObserver<com.optum.grpcserver.Cart> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.optum.grpcserver.Book> getBooksByGender(
        io.grpc.stub.StreamObserver<com.optum.grpcserver.Cart> responseObserver) {
  ...
  public static final class BookAuthorServiceBlockingStub extends io.grpc.stub.AbstractStub<BookAuthorServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.optum.grpcserver.Author getAuthor(com.optum.grpcserver.Author request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.optum.grpcserver.Book> getBooksByAuthor(
        com.optum.grpcserver.Author request) {
  ...
  public static final class BookAuthorServiceFutureStub extends io.grpc.stub.AbstractStub<BookAuthorServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.optum.grpcserver.Author> getAuthor(
        com.optum.grpcserver.Author request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AUTHOR:
          serviceImpl.getAuthor((com.optum.grpcserver.Author) request,
              (io.grpc.stub.StreamObserver<com.optum.grpcserver.Author>) responseObserver);
          break;
        case METHODID_GET_BOOKS_BY_AUTHOR:
          serviceImpl.getBooksByAuthor((com.optum.grpcserver.Author) request,
              (io.grpc.stub.StreamObserver<com.optum.grpcserver.Book>) responseObserver);
          break;
        default:
  ...
  private static final class BookAuthorServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.optum.grpcserver.Schema.getDescriptor();
    }
  }
